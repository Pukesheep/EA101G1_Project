...
${memberVO.mem_name}
	<div>${memberVO.mem_id}</div>
			<form method="post" action="<%=request.getContextPath()%>/front-end/immed/findByImmedName.jsp">
				<input type="text" name="immed_search"> <input
					type="hidden" name="action" value="find_By_Immed_Name"> <input
				...
				<c:forEach var="immedVO" items="${list}" begin="<%=pageIndex%>"
					...
					<div class="col-6 col-md-3">
						<div class="card mb-4 px-2 pt-2">
							...
							<div class="card-body">
								<a
									href="<%=request.getContextPath()%>/front-end/immed/immed.do?immedID=${immedVO.immed_id}"
