...
<!-- 					style="font-size: 40px"> -->
			...
			<b class="bg-light" style="color: rgb(102, 102, 102);">共 <font><%=list.size()%></font>
				件商品
			</b>
...
<%-- 				end="<%=pageIndex+rowsPerPage-1%>"> --%>
				<div class="row justify-content mb-2  rounded"
					...
					<div class="col-2 align-self-center">
						<FORM METHOD="post"
							...
							<input type="submit" class="btn btn-light" value="取消"> <input
			...
			<div class="shopee-search-empty-result-section"
				...
				<div class="shopee-search-empty-result-section__title"
					style="opacity: 0.5; font-size: 20px">未收藏商品</div>
				<div class="shopee-search-empty-result-section__hint"
					style="opacity: 0.5; font-size: 20px;">拜託收藏加三連</div>
			</div>
			<%
				}
			%>
