...
<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/protected/shopCart/style.css">
...
<body>
	...
	<script src="<%=request.getContextPath()%>/front-end/protected/shopCart/pay.js"></script>
