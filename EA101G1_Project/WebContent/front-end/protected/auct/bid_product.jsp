...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/css/bid_product.css">
            ...
            <div class="auct-list row px-3 py-3">
                    ...
                    <div class="product col-md-4 mb-3">
                        <div class="product-rel">
                            ...
                            <div class="auct-list">
                                <div>
                                    <img class="produce-img" src="<%=request.getContextPath()%>/front-end/auct/pic.do?auct_id=${auctVO.auct_id}" alt="">
                                </div>
                                <div class="mt-3">
                                    <ul class="ml-5">
                                        <li class="text-left">拍賣編號: ${auctVO.auct_id}</li>
                                        <li class="text-left">商品分類: ${PtSvc.getOneProductType(auctVO.pt_id).typename}</li>
                                        <li class="text-left">拍賣者&nbsp&nbsp:&nbsp ${MemberSvc.getOneMember(auctVO.sale_id).mem_name} </li>
                                        <li class="text-left">開始時間: <fmt:formatDate value="${auctVO.auct_start}" pattern="yyyy-MM-dd HH:mm:ss" /></li>
                                        <li class="text-left">起標價&nbsp&nbsp:&nbsp ${auctVO.initPrice} 元</li>
                    ...
                    <div class="product col-md-4 ">
                        <div class="product-rel">
                            <div class="auct-title  py-2">
                                <h4 class="text-center" > ${auctVO.initPrice} 元</h4>
                            ...
                            <div class="auct-list1 mx-5">
                                <div class=" py-2 bg-white">
                                    <ul>
                                        ...
                                        <li class="market">NTD  ${auctVO.initPrice} </li>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li><button type="submit" class="bid-btn my-2" id="button" onclick="sendMessage();">BID / 競標</button></li>
                                </ul> 
                            </div>
                        </div>
                    </div>
