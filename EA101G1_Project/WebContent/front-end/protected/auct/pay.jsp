...
<body>
	...
	<div class="container">
		<div class="row">
            ...
            <g id="Front">
                ...
                <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">8385 9468 4960 4958</text>
                <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">A Biao</text>
                <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">cardholder name</text>
                <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">expiration</text>
                <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">card number</text>
                <g>
                    <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" class="st2 st5 st9">05/23</text>
        ...
        <g id="Back">
            ...
            <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">636</text>
            <g class="st8">
                <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security code</text>
            </g>
            <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
            <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
            <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">A Biao</text>
        </g>
    </svg>
					</div>
				</div>
		...
		<div class="row justify-content-center">
			<div class="col-3">
					<div class="field-container text-center">
						...
						<input id="name" maxlength="20" type="text" value="${memberVO.mem_name}" required>
					</div>
					<div class="field-container text-center">
						<label for="cardnumber">
							<b>- 卡片號碼 -</b>
						</label>
						<input id="cardnumber" type="text" value="${memberVO.card_no}" required>
	...
	<script src="<%=request.getContextPath()%>/front-end/protected/auct/pay.js"></script>
	...
	function insertValue() {
		$('#name').val('阿標');
		$('#cardnumber').val('8385 9468 4960 4958');
		$('#expirationdate').val('05/23');
		$('#securitycode').val('636');
	}
</script>
</body>
