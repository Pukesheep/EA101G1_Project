...
<ul>
 ...
 <li><a href='<%=request.getContextPath()%>/back-end/psac/listAllPsac.jsp'>查詢全部檢舉案</a>  <br><br></li>
 <li>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back-end/psac/addPsac.jsp'>新增文章檢舉案</a></li>
</ul>
</div>
