		...
		<div class="content d-md-flex">
			...
			<div>
				<table>
					...
					<c:forEach var="poVO" items="${list}" begin="<%=pageIndex%>"
						...
						<tr>
							...
							<td>
								<FORM METHOD="post"
									ACTION="<%=request.getContextPath()%>/productOrder/Po.do"
									style="margin-bottom: 0px;">
									<input type="submit" value="出貨"> <input type="hidden"
										name="po_id" value="${poVO.po_id}"> <input
										type="hidden" name="ordstat_id" value="006"> <input
										type="hidden" name="url"
										value="<%=request.getServletPath()%>?<%=request.getQueryString()%>">
