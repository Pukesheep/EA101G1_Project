...
<%-- 				<td><input type="text" name="bon_status" size="45" value=<%=bmVO.getBon_status()%>/></td> --%>
	...
	<input type="hidden" name="bon_exchange" value="${bmVO.bon_exchange}">
	<input type="hidden" name="bon_addDate" value="${bmVO.bon_addDate}">
...
<!-- // 						<h4> -->
<!-- // 							<a -->
<%-- <%-- 								href="<%=request.getContextPath()%>/back-end/BounsMall/ListAll.jsp"><img --%> --%>
...
<!-- // 						<td>已兌換數量：</td> -->
<%-- <%-- 									<td><input type="text" name="bon_exchange" size="45" value=<%=bmVO.getBon_exchange()%> /></td> --%> --%>
<!-- // 						<td><input type="text" name="bon_exchange" size="45" -->
<%-- // 							value="${bmVO.bon_exchange}" /></td> --%>
<!-- // 					</tr> -->
<!-- // 					<tr> -->
<!-- // 						<td>現有總庫存：</td> -->
<%-- <%-- 									<td><input type="text" name="bon_stock" size="45" value=<%=bmVO.getBon_stock()%>/></td> --%> --%>
...
<!-- // 					<tr> -->
<!-- // 						<td>上架日期：</td> -->
<%-- // 						<td><input name="bon_addDate" id="f_date1" type="hidden" />${bmVO.bon_addDate}</td> --%>
<!-- // 					</tr> -->

<!-- // 					<tr> -->
<!-- // 						<td>紅利商品上架狀態：</td> -->
<%-- <%-- 									<td><input type="text" name="bon_status" size="45" value=<%=bmVO.getBon_status()%>/></td> --%> --%>
<!-- // 						<td><input type="text" name="bon_status" size="45" -->
<%-- // 							value="${bmVO.bon_status}" /></td> --%>
<!-- // 					</tr> -->
<!-- // 				</table> -->

<!-- // 				<br> <input type="hidden" name="action" value="update"> -->
<%-- // 				<input type="hidden" name="bon_id" value="${bmVO.bon_id}"> <input --%>
